...
class Plugin {
	...
	protected static function isPHPCompatible(): bool {
		return (int) version_compare( PHP_VERSION, WLMI_MINIMUM_PHP_VERSION, '>=' ) > 0;
	}
	...
	protected static function isWordPressCompatible(): bool {
		return (int) version_compare( get_bloginfo( 'version' ), WLMI_MINIMUM_WP_VERSION, '>=' ) > 0;
	}
	...
	protected static function isWooCompatible(): bool {
		...
		return (int) version_compare( $woo_version, WLMI_MINIMUM_WC_VERSION, '>=' ) > 0;
	}
	...
	protected static function isLoyaltyCompatible(): bool {
		return (int) version_compare( self::getLoyaltyVersion(), WLMI_MINIMUM_WLR_VERSION, '>=' ) > 0;
	}
